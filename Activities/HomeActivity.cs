...
{
	[Activity (Label = "Home",   LaunchMode = LaunchMode.SingleTop, Icon = "@drawable/ic_launcher")]
	public class HomeView : BaseActivity
	{
		...
		private static readonly string[] Sections = new[] {
			"Zdarzenia","Moje dane", "Wyniki badañ", "Wizyty", "Kontakty", "Hospitalizacja i operacje", "Leki", "Alergie", "Szczepienia"  
		};
		...
		private void ListItemClicked (int position)
		{
			...
			switch (position) {
            case 0:
                fragment = new Zdarzenia();
                break;
            case 1:
				fragment = new MojeDane();
				break;
			case 2:
				fragment = new Wyniki_badan();
				break;
			case 3:
				fragment = new wizyty();
				break;
            case 4:
                fragment = new Kontakty();
                break;
            case 5:
                fragment = new Hospitalizacje();
                break;
            case 6:
                fragment = new Leki();
            break;
            case 7:
                fragment = new Alergie();
                break;
            case 8:
                fragment = new Szczepienia();
                break;
